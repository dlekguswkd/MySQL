...
select hire_date
		, case when hire_date <= 021231 then '창립멤버'
				when hire_date > 021231 and hire_date <= 031231 then '03년입사'
        		when hire_date > 031231 and hire_date <= 041231 then '04년입사'
				else '상장이후입사'
        end as optDate
from employees
...
select date_format(min(hire_date), '%Y년 %m월 %d일 %a요일') 
from employees;
