/****************************************************************
	practice03		테이블간 조인(JOIN) SQL 문제
****************************************************************/
...
select e.employee_id
		,concat(e.last_name,'  ', e.first_name) 풀네임
        , jh.job_id
        , jh.start_date
        , jh.end_date
...
이름(countries_name) 그리고 지역구분(regions)의 이름(resion_name)까지 전부 출력해 보세요. (11건)
*/
...
/*
문제9-1.
문제9 에서 부서가 없는 직원(Kimberely)은 표시하고. 매니저가 없는 Steven은 표시하지 않습니다. 
(106명)
*/
...
/*
문제9-2.
문제9 에서 부서가 없는 직원(Kimberely)도 표시하지 않고 매니저가 없는 Steven도 표시하지 않습니다. 
(105명)
*/
